...
int strings_in_line_ERROR(sorter_error_code code){
...
sorter_error_code strings_in_line_ctor_file(struct strings_in_line *line, char* filename){
...
sorter_error_code strings_in_line_output(struct strings_in_line line)
{
    if(line.string == NULL){
        return SORTER_ERROR_NO_POINTER;
    }
...
sorter_error_code strings_in_line_output_file(struct strings_in_line line, FILE* file)
{
    if(line.string == NULL){
        return SORTER_ERROR_NO_POINTER;
    }
...
sorter_error_code strings_in_line_output_beginning (struct strings_in_line line)
{
    if(line.string == NULL){
        return SORTER_ERROR_NO_POINTER;
    }
...
sorter_error_code strings_in_line_output_beginning_file (struct strings_in_line line, FILE* file)
{
    if(line.string == NULL){
        return SORTER_ERROR_NO_POINTER;
    }
...
int strings_in_line_comparator(struct strings string1, struct strings string2,  comparator_mode mode)
{
...
int strings_in_line_comparator_bigger_beginning(const void* string1,const void* string2){
    return strings_in_line_comparator(*(struct strings*)string1, *(struct strings*)string2, COMPARATOR_STRINGS_BIGGER_BEGINNING);
}

int strings_in_line_comparator_back_bigger_beginning(const void* string1,const void* string2){
    return strings_in_line_comparator(*(struct strings*)string1, *(struct strings*)string2, COMPARATOR_STRINGS_BACK_BIGGER_BEGINNING);
}

int strings_in_line_comparator_pointers(const void* string1,const void* string2){
    return strings_in_line_comparator(*(struct strings*)string1, *(struct strings*)string2, COMPARATOR_STRINGS_POINTERS);
}

sorter_error_code strings_in_line_quick_sort(struct strings_in_line *line, long long leftpointer, long long rightpointer, comparator_mode mode){
    if (line == NULL){
        return SORTER_ERROR_NO_POINTER;
    }
    ...
    while (leftpointer < rightpointer){
        while (leftpointer < rightpointer && strings_in_line_comparator(stringcompare, line->string[rightpointer], mode) < 0){
            rightpointer--;
        }
        ...
        while (leftpointer < rightpointer && strings_in_line_comparator(line->string[leftpointer], stringcompare, mode) < 0){
            leftpointer++;
        }
        if (leftpointer != rightpointer){
    ...
    rightpointer = right;
    if (left < k){
        strings_in_line_quick_sort(line, left, k - 1, mode);
    }
    if (right > k){
        strings_in_line_quick_sort(line, k + 1, right, mode);
    }
    return SORTER_ERROR_OK;
}

sorter_error_code strings_in_line_qsort(struct strings_in_line line, int(*comparator)(const void*, const void*)){
    qsort(line.string, line.number_of_strings, sizeof(struct strings), comparator);
    return SORTER_ERROR_OK;
}

sorter_error_code strings_in_line_quick_sort_no_boulders(struct strings_in_line *line, comparator_mode mode){
    return strings_in_line_quick_sort(line, 0, line->number_of_strings - 1, mode);
}
